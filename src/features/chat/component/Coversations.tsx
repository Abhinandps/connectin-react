...
export function Coversations({ data, currentUser, online, unreadMessagesCount, isCurrentUserParticipant, hasUnreadMessages }: any) {
  ...
  return (
    <div className={`${isCurrentUserParticipant && hasUnreadMessages && 'bg-[#edf3f8] '} flex items-center gap-2 py-3 relative hover:bg-[#edf3f8] px-3 cursor-pointer border-b  border-borderColor relative`}>
      ...
      <div className=''>
        ...
        <p className='font-light text-secondaryColor text-xs'>{
